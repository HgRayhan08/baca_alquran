...
import 'package:aplikasi_suara_ilahi/data/repository/data_asmaul_husna_repository.dart';
import 'package:aplikasi_suara_ilahi/data/repository/data_detail_surat_repository.dart';
import 'package:aplikasi_suara_ilahi/data/repository/data_doa_repository.dart';
...
void init() {
  ...
  locator.registerLazySingleton<EasmaulHusnaRepository>(() => AsmaulHusna());
  locator.registerLazySingleton<EDoaRepository>(() => DoaDataResource());
  ...
  locator.registerLazySingleton<AsmaulHusnaRepository>(
      () => DataAsmaulHusnaRepository(asmaulHusna: locator()));
  locator.registerLazySingleton<DoaRepository>(
      () => DataDoaRepository(doaRepository: locator()));
  ...
  locator.registerLazySingleton(() => GetAsmaulHusna(locator()));
  locator.registerLazySingleton(() => GetDoa(locator()));
  ...
  locator.registerFactory(() => AsmaulHusnaBloc(locator()));
  locator.registerFactory(() => DoaBloc(locator()));
}
